    ...
    <div id="box">
			...
			<div id="centre">
				...
				<div id="d3">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>性别：</label><asp:RadioButton ID="radMan"
                        runat="server" GroupName="sex" Checked="True" Text="男" /><asp:RadioButton ID="radWoman" runat="server" GroupName="sex" Text="女" /><br /><br />
